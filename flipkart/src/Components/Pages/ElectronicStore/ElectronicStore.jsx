...
import styles from './ElectronicStore.module.css'
...
const ElectronicStore = () => {
    ...
    //getting the product data to display in this page
    ...
    return (
        ...
        <Grid container className={styles.margin} >
            ...
            <Grid item xs={8} sm={9} md={10} lg={10}>
                ...
                {/* filter product by electronic category and apply sorting feature */}
                {
                    product.filter((item) => item.category === "electronic")
                    ...
                    .map((items) => (
                        <div className={styles.card} onClick={() => handleClick(items.id)}>
                            <img src={items.img} width="100%" height="200px" alt="product" />
